...
def moviequery():    
    ...
    if movie_found == True:
        dict_movie = {'TI':json_doc[0]['Title'], 'RD':json_doc[0]['Year'], 'R':json_doc[0]['Runtime'], 'G':json_doc[0]['Genre'], 'D':json_doc[0]['Director'], 'A':json_doc[0]['Actors'], 'I':json_doc[0]['imdbRating'], 'V':json_doc[0]['imdbVotes'], 'P':json_doc[0]['Plot'], 'AW':json_doc[0]['Awards']}
...
def faqentry():
    ...
    return render_template('FAQR.html')
